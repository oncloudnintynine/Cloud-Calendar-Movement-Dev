...
<div class="relative">
<input type="text" id="kah-group-search-${i}" placeholder="Add personnel to group..." class="w-full text-sm py-1.5 px-3 border-2 border-gray-300 dark:border-gray-500 rounded-lg outline-none shadow-sm focus:border-blue-500 bg-white dark:bg-black text-gray-900 dark:text-white transition" autocomplete="off" onkeyup="debouncedSearchKahGroupMember(${i})">
...
const debouncedSearchKahGroupMember = debounce(searchKahGroupMember, 300);
...
const debouncedSearchUserToManage = debounce(searchUserToManage, 300);
