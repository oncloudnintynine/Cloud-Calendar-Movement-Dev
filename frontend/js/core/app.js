...
window.appAgendaDetailsTemplate = settings.agendaDetailsTemplate || 'Time: {Time}\nLocation: {Location}\nAttendees: {Attendees}\nEvent Description: {EventDescription}';
window.appInfoAllTemplate = settings.infoAllTemplate || '{EventType} - {Name} ({Department})';
window.appInfoAllDetailsTemplate = settings.infoAllDetailsTemplate || 'Time: {Time}\nLocation: {Location}\nEvent Description: {EventDescription}';
