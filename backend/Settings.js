...
agendaDetailsTemplate: props.getProperty('agendaDetailsTemplate') || 'Time: {Time}\nLocation: {Location}\nAttendees: {Attendees}\nEvent Description: {EventDescription}',
infoAllTemplate: props.getProperty('infoAllTemplate') || '{EventType} - {Name} ({Department})',
infoAllDetailsTemplate: props.getProperty('infoAllDetailsTemplate') || 'Time: {Time}\nLocation: {Location}\nEvent Description: {EventDescription}',
